...
public class signup extends AppCompatActivity  {
        ...
        btnsignup.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if(!signup_password.getText().toString().equals(signup_repassword.getText().toString())){
                    Toast.makeText(signup.this,"Password and Repassword is not matching",Toast.LENGTH_SHORT).show();
                }else {
                    submitForm();
                }
            }
    ...
    public void submitForm() {
        new RegisterTask().execute(signup_email.getText().toString(),signup_name.getText().toString(),signup_password.getText().toString());
    }
        ...
        protected void onPostExecute(String response){
            ...
            return;
                ...
                if(j.has("error")){
                    ...
                    JSONArray full_msg=errors.getJSONArray("full_messeges");
                    String error_msg=full_msg.join(",");
                    Toast.makeText(getApplicationContext(),"Error -"+error_msg,Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(getApplicationContext(),"Thank you ! Registration successfull",Toast.LENGTH_LONG).show();
